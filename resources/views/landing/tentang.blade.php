...
<section class="py-5">
    <div class="container">
        ...
        <p>
            Sistem ini dibangun agar seluruh aktivitas peminjaman dapat berlangsung secara 
            digital, aman, efisien, dan terdokumentasi dengan baik. 
        </p>

        <h3 class="fw-bold mt-4">Visi</h3>
        <p>Mewujudkan sistem peminjaman kendaraan yang modern, cepat, dan transparan.</p>
